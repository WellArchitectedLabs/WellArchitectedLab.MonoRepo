namespace WfExperience.Bff.Api.Dtos.WeatherInsight.Get.Response;
...
public static class GetWeatherInsightDtoFactory
{
    public static IEnumerable<GetWeatherInsightDto> CreateFromDomain(
        IEnumerable<WfExperience.Bff.Domain.AggregateModel.Forecast.WeatherForecast> weatherInsights)
    {
