...
def main():
    ...
    wf_imports.add_argument("--from-date", required=False)
    wf_imports.add_argument("--to-date", required=False)
    ...
    wf_imports.add_argument("--cities-input", required=False, help="Path to cities csv")
    wf_imports.add_argument("--input", required=False, help="Path to weather csv. Imports the given csv file into the configured database on config level. Use when you would like to import an already generated weatehr forecasts file.")
