...
## Overview
**MasterData.Client** is the official .NET client library providing a clean, typed connector to the **Master Data API**.  
...
## Prerequisites
- **.NET 10 or higher**  
- **Network access** to the Master Data API over a private network  
- **HTTP/1.1 support**  
...
```bash
dotnet add package MasterData.Client
```
...
```csharp
services.RegisterMasterDataClient(options =>
{
